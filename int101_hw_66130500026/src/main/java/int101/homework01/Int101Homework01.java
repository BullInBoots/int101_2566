...
import static int101.homework01.work03.MyUtil.*;
...
public class Int101Homework01 {
   ...
   static void work04UseOfObjectClass() {
      ...
      */
      ...
      BankAccount person1Bank = new BankAccount(1, person1);
      BankAccount person2Bank = new BankAccount(2, person2);
      
      // Add 1000 baht to all account;
      person1Bank.deposit(1000);
      person2Bank.deposit(1000);
      System.out.println("Person 1 balance : " + person1Bank.getBalance());
      System.out.println("Person 2 balance : " + person2Bank.getBalance());


      // Person1 transfer 500 baht to Person2
      person1Bank.transfer(500, person2Bank);

       System.out.println("Person 1 Transfer 500 to Person 2");
       System.out.println("Person 1 balance : " + person1Bank.getBalance());
       System.out.println("Person 2 balance : " + person2Bank.getBalance());
   }
}
